<?php	
	...
	class RedPacket
	{
		 ...
		 */
		public function sendOrdinaryRedPacket($re_openid, $nCent)
		{	
			...
			{
				//$this->curl_get('http://red-space.cn/RedChocoErr/displayErr.php?red_packet_error=' . SEND_NAME . '——' .  $re_openid .'——'. $xmlArr["err_code_des"]);
